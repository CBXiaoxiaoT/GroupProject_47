...
class PieChart(QWidget):
    # this is a pie chart use in Month budget area
...
class ExpenseCard(QWidget):
    def __init__(self, record_data, parent=None):
        ...
        # show + when the amount is positive
        if float(amt) > 0:
...
# This is the widget to show data in All and category pages
class MonthSummaryWidget(QWidget):
    def __init__(self, month_info: dict, db, parent=None, forced_category=None):
        ...
        # click detail to show the detail card
    ...
    def load_detail_cards(self):
        ...
        for rec in records:
            ...
            # according to parent's delete_mode to show/hide "X"
