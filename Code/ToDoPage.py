...
##############################################################################
# The time label in recent page, like "Mar 25   Tuesday   Today"
##############################################################################
...
##############################################################################
# choose the circle color of the category when editing
##############################################################################
class ColorPickerDialog(QDialog):
    # colors, you can add your own color
    COLOR_ITEMS = [
        ("#FF6666", "#DD4444"),
        ("#66CC66", "#44AA44"),
        ("#66CCCC", "#44AAAA"),
    ...
    def __init__(self, parent=None):
        ...
        # use HBoxLayout to show our color
...
##############################################################################
# ToDoCard, show the information of one record
##############################################################################
class ToDoCard(QWidget):
    def __init__(self, todo_data, parent=None, parent_page=None):
        ...
        # show the color of the category
        ...
        if self.todo_data.get("collected", False):
            self.collection_btn.setText("★")  # show ☆ when collected
        # Delete button
    ...
    # Refresh the data use the new data
...
class Todo_MainWindow(QMainWindow):
    ...
    #### left panel
        ...
        # add the four buttons into QButtonGroup, so that they are mutual exclusion
        ...
        # QScrollArea to store category label
    ...
    ###### right QStackedWidget
        ...
        # focus on recent_btn first time
        self.recent_btn.setChecked(True)
        self.pages_widget.setCurrentIndex(0)

        # update category_buttons
