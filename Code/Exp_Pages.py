...
class TodayPage(QWidget):
    def __init__(self, parent=None):
        ...
        # top left, show today's information
        ...
        # top left, show months' budget and pie chart
        ...
        # bottom area to show today's record
